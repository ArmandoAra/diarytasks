...
import { CreateTaskProps, DataTaskProps, Task } from '@/interfaces/TasksInterfaces';
registerTranslation('en', en)

// Db
import { insertTask } from "../../db/db"
...
const CreateTask = () => {
  ...
  const onConfirm = React.useCallback((params: any) => {
    ...
    handleChanges('dates', params.dates);
    console.log('[on-change-multi]', params);
  }, []);


  const handleChanges = (key: keyof Task, value: string | Date) => {
    ...
    <ScrollView style={styles.container} >
      <View style={{ flex: 12 }}>
        ...
        <View style={{ borderRadius: 10, borderWidth: 1, backgroundColor: '#a8232300', overflow: 'hidden' }}>
          <Picker
            selectedValue={data.importanceLevel}
            onValueChange={(value) => handleChanges("importanceLevel", value)}
            style={styles.picker}
          >
